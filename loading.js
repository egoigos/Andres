function es(){
    ...
    document.getElementById("btn").innerHTML=       '<a href="https://drive.google.com/open?id=1c4jyZqax_rO_lMuUxyKY3GNuh6SS1KZp">Descargar CV</a>';
}
...
function eng(){
    ...
    document.getElementById("btn").innerHTML=       '<a href="https://drive.google.com/open?id=1_4MH8K4qsAJgiMnCVU0whbu1xm-nswbC">Download CV</a>';
}
...
function va(){
    ...
    document.getElementById("txt").innerHTML=       "<p>Lament les molèsties, estic dissenyant el contingut.<br />En breu estarà disponible. </p><p>Mentrestant pots descarregar el CV el botó corresponent, moltes gràcies.</p>";
    document.getElementById("btn").innerHTML=       '<a href="https://drive.google.com/open?id=1c4jyZqax_rO_lMuUxyKY3GNuh6SS1KZp">Descarregar CV</a>';
}
...
function de(){
    ...
    document.getElementById("btn").innerHTML=       '<a href="https://drive.google.com/open?id=1NSWitc3Oabzp_1fkc-6JKUhVhsQZggL0">Herunterladen CV</a>';
}
